    ...
    Private Sub BtnSubmit_Click(sender As Object, e As EventArgs) Handles BtnSubmit.Click
        ...
        Else
            If TxtProfile.Text.Contains("https://thedivinityrp.net/forum/member") Or TxtProfile.Text = String.Empty Then
                ...
                myConnection.Open()
                Dim str As String
                str = "INSERT INTO GlobalRecords([SteamID],[RP Name],[Forum Name],[Nickname],[Highest Known Position],[Profile]) VALUES (@SteamID,@RPName,@ForumName,@Nickname,@HighestKnownPosition,@Profile)"
